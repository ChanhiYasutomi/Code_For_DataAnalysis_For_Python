# technician
technician_tmp = df_technician[['BC ID','technician　Name']].drop_duplicates()
...
# category
category_tmp = df_video_tags[['Categories',"BC ID"]].drop_duplicates()
...
# tech
tech_tmp = df_video_tags[['tech name',"BC ID"]].drop_duplicates()
